                ...
                - generic [ref=f1e392]:
                  ...
                  - generic [ref=f1e400]:
                    ...
                    - link [ref=f1e435] [cursor=pointer]:
                      - /url: "#"
            - 'row "Remote Include Controller: Page-IncludeHeaderMenu (app_babylisspro_sfra) Template: /default//components/header/menu.isml (app_babylisspro_sfra) Processing Time: 20 ms Caching Status: Cached until: 11/18/2025 1:21 pm" [ref=f1e436]':
              - 'cell "Remote Include Controller: Page-IncludeHeaderMenu (app_babylisspro_sfra) Template: /default//components/header/menu.isml (app_babylisspro_sfra) Processing Time: 20 ms Caching Status: Cached until: 11/18/2025 1:21 pm" [ref=f1e437]':
                - generic [ref=f1e438]:
                  ...
                  - generic [ref=f1e446]:
                    - generic [ref=f1e447]:
                      ...
                      - table [ref=f1e473]:
                        - rowgroup [ref=f1e474]:
                          - 'row "Caching Status: Cached until: 11/18/2025 1:21 pm" [ref=f1e475]':
                            - cell "Caching Status:" [ref=f1e476]:
                              - generic [ref=f1e477]: "Caching Status:"
                            - 'cell "Cached until: 11/18/2025 1:21 pm" [ref=f1e478]':
                              - generic [ref=f1e479]: "Cached until: 11/18/2025 1:21 pm"
                    - link [ref=f1e480] [cursor=pointer]:
                      - /url: "#"
            - 'row "Remote Include Controller: Page-Include (app_babylisspro_sfra) Template: /default/components/content/contentAssetInc.isml (app_storefront_base) Processing Time: 11 ms Caching Status: Cached until: 11/18/2025 1:21 pm" [ref=f1e481]':
              - 'cell "Remote Include Controller: Page-Include (app_babylisspro_sfra) Template: /default/components/content/contentAssetInc.isml (app_storefront_base) Processing Time: 11 ms Caching Status: Cached until: 11/18/2025 1:21 pm" [ref=f1e482]':
                - generic [ref=f1e483]:
                  ...
                  - generic [ref=f1e491]:
                    - generic [ref=f1e492]:
                      ...
                      - table [ref=f1e519]:
                        - rowgroup [ref=f1e520]:
                          - 'row "Caching Status: Cached until: 11/18/2025 1:21 pm" [ref=f1e521]':
                            - cell "Caching Status:" [ref=f1e522]:
                              - generic [ref=f1e523]: "Caching Status:"
                            - 'cell "Cached until: 11/18/2025 1:21 pm" [ref=f1e524]':
                              - generic [ref=f1e525]: "Cached until: 11/18/2025 1:21 pm"
